...
`Avenida Ministro José Américo de Almeida, 1378, Torre, João Pessoa - PB (ao lado da Unimed da beira rio)`
  ...
  const DEFAULT_FILIAIS = [
    { codigo: 'F01', nome: 'Ernani Sátiro', telefones: ['83987834315'] },
    { codigo: 'F02', nome: 'Colinas do Sul', telefones: ['83987831334'] },
    { codigo: 'F03', nome: 'Centro (Cabedelo)', telefones: ['83987832809'] },
    { codigo: 'F04', nome: 'Tibiri (Santa Rita)', telefones: ['83987913800'] },
    { codigo: 'F05', nome: 'Manaíra (Mag Shopping)', telefones: ['83988887475'] },
    { codigo: 'F06', nome: 'Cristo Redentor (Rua Pres. Ranieri Mazilli)', telefones: ['83987916273'] },
    { codigo: 'F07', nome: 'Ernesto Geisel', telefones: ['83988111773'] },
    { codigo: 'F08', nome: 'Francy Água Fria (SuperFácil)', telefones: ['83996780068'] },
    { codigo: 'F09', nome: 'Francy Bessa', telefones: ['83987259411'] },
    { codigo: 'F10', nome: 'Francy Cristo Redentor (Rua Heronides Meira de Vasconcelos)', telefones: ['83998060012'] },
    { codigo: 'F11', nome: 'Francy Valentina', telefones: ['83996190016'] },
    { codigo: 'F12', nome: 'Francy Torre', telefones: ['83998710665'] },
    { codigo: 'F14', nome: 'Francy Tambaú', telefones: ['83996780032'] },
    { codigo: 'F15', nome: 'Francy Intermares (Cabedelo)', telefones: ['8321823700'] },
    { codigo: 'F16', nome: 'Francy Miramar', telefones: ['83996780021'] }
  ];
