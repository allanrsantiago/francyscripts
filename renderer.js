...
Ou se preferir você pode pedir um *Uber Flash ou 99 Entregas* que nós entregamos seu pedido a ele.`
  ...
  const FILIAIS = [
    { codigo: 'F01', nome: 'Ernani Sátiro', telefone: '83987834315' },
    { codigo: 'F02', nome: 'Colinas do Sul', telefone: '83987831334' },
    { codigo: 'F03', nome: 'Centro (Cabedelo)', telefone: '83987832809' },
    { codigo: 'F04', nome: 'Tibiri (Santa Rita)', telefone: '83987913800' },
    { codigo: 'F05', nome: 'Manaíra (Mag Shopping)', telefone: '83988887475' },
    { codigo: 'F06', nome: 'Cristo Redentor (Rua Pres. Ranieri Mazilli)', telefone: '83987916273' },
    { codigo: 'F07', nome: 'Ernesto Geisel', telefone: '83988111773' },
    { codigo: 'F08', nome: 'Francy Água Fria (SuperFácil)', telefone: '83996780068' },
    { codigo: 'F09', nome: 'Francy Bessa', telefone: '83987259411' },
    { codigo: 'F10', nome: 'Francy Cristo Redentor (Rua Heronides Meira de Vasconcelos)', telefone: '83998060012' },
    { codigo: 'F11', nome: 'Francy Valentina', telefone: '83996190016' },
    { codigo: 'F12', nome: 'Francy Torre', telefone: '83998710665' },
    { codigo: 'F14', nome: 'Francy Tambaú', telefone: '83996780032' },
    { codigo: 'F15', nome: 'Francy Intermares (Cabedelo)', telefone: '8321823700' },
    { codigo: 'F16', nome: 'Francy Miramar', telefone: '83996780021' }
  ];

  // Formata o telefone conforme a regra: se for fixo (o trecho depois do
  // DDD 83 começa com 2), não tem o 9 inicial; se for celular, o 9 é
  // separado do restante do número.
  function formatTelefoneFilial(raw) {
    const digits = raw.replace(/\D/g, '');
    const ddd = digits.slice(0, 2);
    const resto = digits.slice(2);

    if (resto.startsWith('2')) {
